function [train_param,XTrain,LTrain,XQuery,LQuery,LTrain_only_incre_labels,LQuery_only_incre_labels,seperate  ] = load_dataset(train_param,I_tr,I_te,L_tr,L_te)
 
    fprintf(['-------Precessing dataset------', '\n']);
    train_param.load_type = "second_setting";
    
    if strcmp(train_param.ds_name, 'MIRFLICKR')

        train_param.image_feature_size = 512;
...
%         load('../data_ok/NUS-WIDE_preprocessing_for_FOHmultilabel.mat');
